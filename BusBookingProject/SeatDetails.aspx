...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:8%">
         <div class="panel-heading">
                    <div class="col-lg-8">
                        <h4 style="color: black;">Escolha os assentos, clicando no assento correspondente a baixo:</h4>
                    </div>
                    <div class="col-lg-2"><a href="#" style="padding: 5px;" class="btn btn-success" id="hrefBackUrl" runat="server" title="Voltar para a lista de pesquisa"><i class="fa fa-backward"></i>&nbsp;Voltar para a lista de pesquisa</a></div>
                </div>
                <br />
                <div class="panel-body">
                    <div class="col-lg-8">
                        <table runat="server">
                            <tr>
                                <td style="color:black;font-size:large">Frente</td>
                                ...
                                <td style="color:black;font-size:large">A trás</td>
                            </tr>
                        </table>

                        <div style="margin-top: 10px;overflow:auto">
                            <ul id="seatDescription">
                                <li style="background: url('img/newAvailableSeat.png') no-repeat scroll 0 0 transparent; width: 25%; height: 30%; color: white">Assento disponível</li>
                                <li style="background: url('img/bookedseats.png') no-repeat scroll 0 0 transparent; width: 25%; height: 30%; color: white">Assento reservado</li>
                                <li style="background: url('img/newSelectedSeat.png') no-repeat scroll 0 0 transparent; width: 25%; height: 30%; color: white">Assento selecionado</li>
                            </ul>
                        </div>
                        <div style="clear: both; width: 100%; margin-top: 70px;">
                            <input type="button" id="btnShowNew" value="Mostrar assentos selecionados" />
                        ...
                        <asp:Label ID="lbldate" runat="server" Font-Bold="true"></asp:Label><br />
                                ...
                                <div class="col-lg-12">
                                    <table class="table-bordered">
                                        <tr>
                                            <td>Nemhum assento selecionado</td>
                                            <td>
