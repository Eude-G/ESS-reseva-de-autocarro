                    ...
                    <div style="padding-top: 30px" class="panel-body">
                        ...
                        <div id="loginform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <asp:TextBox runat="server" ID="txtPassword" placeholder="Digite a aqui a sua senha" TextMode="Password" CssClass="form-control" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPassword" Display="None" CssClass="text-danger" ID="rfvPassword"
                                    ErrorMessage="A palavra é obrigatória." ValidationGroup="vgLogin" />
                            </div>
                            ...
                            <div  class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    ...
                                    <a href="UserRegistration.aspx">Cadastrar um novo usuário</a>
                                </div>
                            </div>
                        </div>
                    </div>
